const API_ROOT = 'https://click-clack-vercel-server.vercel.app/api/v1'
...
export async function getTests() {
    ...
    const response = await fetch(`https://click-clack-vercel-server.vercel.app/api/v1/tests/get-tests/`, {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
        },
...
export async function logOutReq(){
    const response = await fetch(`https://click-clack-vercel-server.vercel.app/api/v1/auth/logout/`, {
        credentials: "include",
        method: "GET",
        headers: {
            "Content-Type": "application/json",
